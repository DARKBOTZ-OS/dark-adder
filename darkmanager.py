...
def banner():
   ...
   ' ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝',
    ...
    #print('=============Made With ❤ by @DGABHI==============')
    print(f'   Version: 1.0 | Author: @ITZABHIXD{n}\n')
    ...
    if a == 1:
        ...
        with open('vars.txt', 'ab') as g:
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 7377287 , '3cae53dab85eb231ce6095b3b92e9d86')
                c.start(number)
        ...
        if float(version.text) > 0.9:
            ...
            print(f'{lg}[i] Your Dark Scraper is already up to date')
            input('Press enter to goto main menu...')
    elif a == 5:
        clr()
        banner()
